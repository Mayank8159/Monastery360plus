...
const monumentsData = {
  ...
  lachen: {
    ...
    description:"Rising majestically in the heart of Sikkim, Lachen Monastery is a living testament to the Nyingma sect of Tibetan Buddhism. Dating back to 1858, this sacred site, also known as Ngodub Choling, is one of the oldest and most revered monasteries in the region. Nestled amidst snow-capped peaks, it offers a serene and spiritual retreat for both monks and visitors. The monastery is home to a rich collection of Buddhist artifacts and ancient manuscripts, and its interior is adorned with vibrant murals and intricate religious art. It also plays a vital role in the local community, hosting important ceremonies and an annual mask dance that draws people from all over. The tranquil ambiance, combined with the breathtaking natural beauty surrounding Lachen Monastery, makes it a must-visit destination for those seeking spiritual solace and a deeper understanding of Sikkim's rich Buddhist heritage.",
    image:
  ...
  lachung: {
    ...
    description:"Located in the picturesque Yumthang Valley, Lachung Monastery is a significant spiritual center for the Nyingma sect of Tibetan Buddhism. Established in 1880, this monastery, also known as Samten Cheoling, is a small but colorful structure with a two-story prayer hall. Its interior is decorated with intricate murals and ancient statues, and its premises are adorned with prayer wheels and flags, offering a serene environment for contemplation. Surrounded by lush landscapes and apple orchards, the monastery provides a tranquil retreat and a glimpse into the rich Buddhist heritage of Sikkim. Lachung Monastery is not only a place of worship but also a cultural hub, hosting traditional festivals and rituals that attract both locals and tourists. The annual mask dance festival, in particular, is a vibrant event that showcases the region's spiritual traditions. Visitors to Lachung Monastery can experience the peaceful ambiance, engage with the local monastic community, and enjoy the stunning natural beauty of the surrounding valley, making it a memorable destination for those exploring Sikkim's spiritual landscape.",
    image:
  ...
  ralang: {
    ...
    description:"Ralang Monastery is one of the most significant and sacred monasteries in Sikkim, belonging to the Kagyu sect of Tibetan Buddhism. The original monastery was built in 1768 AD by the fourth Chogyal of Sikkim to commemorate his successful pilgrimage to Tibet. A new, larger monastery, known as the Palchen Choeling Monastic Institute, was built in 1995. Ralang Monastery is known for its extensive collection of paintings and thangkas, as well as its genuine Tibetan architecture. It hosts several annual festivals, including the Pang Lhabsol and the Chaam Mask Dances, which celebrate the worship of Mount Kanchenjunga and are a major attraction for visitors. The monastery is also a center for learning, where monks study Buddhist philosophy, rituals, and meditation practices. Surrounded by lush greenery and offering stunning views of the Himalayas, Ralang Monastery provides a serene and spiritual atmosphere for both devotees and tourists. Its rich cultural heritage, combined with its peaceful setting, makes it a must-visit destination for those interested in Sikkim's religious traditions and natural beauty.",
    image:
